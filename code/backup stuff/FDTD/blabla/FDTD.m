...
for T=1:12000
    ...
    eps_space = assign_val(eps_space, xrange, yrange, modLeft, (eps_wg + 0.1*eps_wg*cos(Omega * T * dt))); 
    eps_space = assign_val(eps_space, xrange, yrange, modRight, (eps_wg + 0.1*eps_wg*cos(Omega * T * dt + pi/2))); 
